...
class MagazineTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        performSegue(withIdentifier: "ShowMagazineSegue", sender: newsFeedArray[indexPath.row].link)
    ...
    func retrieveData(numberitems: Int){
        ...
        Alamofire.request(Const.GET_MESSAGE_BY_MAGAZINE, method: .post, parameters: parameters).responseJSON { response in
